...
#
# Generated by export_simulation on Wed May 16 18:48:01 +0200 2018
#
################################################################################
...
switch to the './vio_DDS.sh' script.

./vio_DDS.sh -reset_run
...
./vio_DDS.sh -noclean_files

For more information on the script, please type './vio_DDS.sh -help'.
