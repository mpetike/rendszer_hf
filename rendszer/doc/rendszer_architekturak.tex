...
\begin{figure}[h!]
	...
	\label{fig:axireadsim}
	\end{center}
	\caption{AXI olvasási ciklusok}
\end{figure}

A \ref{fig:axireadsim} látható egy AXI olvasási ciklus. Látszik hogy a címet megadva és a handshake után megjelenik a kiolvasandó adat a megfelelő csatornáján.
